/*-----------------------------------------------------------*/
/* Inserción de datos */
insert into director_admin values ('11992312K', 'Francisco Silgado Macías', 58, 2450, 'C/Intenso N 34', 176);
insert into director_admin values ('73765142M', 'María Sánchez García', 52, 2600, 'C/Vivaldi N 23', 184);
insert into director_admin values ('81723465P', 'Paula Méndez Arias', 42, 1860, 'C/Catador N 41', 182);
insert into director_admin values ('83890412S', 'Ana María Delgado de la Rosa', 36, 2100, 'Avda del Rocío N 32 A', 166);
insert into director_admin values ('92398132H', 'Antonio Pérez Delgado', 33, 1920, 'C/Blanco White N 16', 160);
...
insert into gerente values ('33241123C', 'Francisco Javier Cortina Lumbreras', 28, 1350, 'Vía Lorem ipsum, 106A 3ºH', 202);
...
insert into centro_trabajo values(113921, 'Ctra. Hornos, 13', '19/06/2020', '73761928B', 122783);
insert into centro_trabajo values(777638, 'C/ Domingo Beltrán, 59', '05/08/2020', '66534267J', 823716);
insert into centro_trabajo values(798002, 'C/ Eras, 24', '15/07/2016', '33241123C', 923812);
insert into centro_trabajo values(837212, 'Celso Emilio Ferreiro, 16', '09/05/2019', '83719938N', 632521);

insert into director_escolar values ('23313424F', 'Erato Corona Arreola', 67, 113921);
insert into director_escolar values ('33126645V', 'Bela Riojas Alarcón', 45, 798002);
insert into director_escolar values ('41427686G', 'Celmira Enríquez Esquivel', 34, 837212);

insert into centro_escolar values (100231, 'Avda. de la Estación, 99', '09/09/1996', '23313424F', 113921);
insert into centro_escolar values (332442, 'Escuadro, 85', '20/04/2002', '41427686G', 837212);
insert into centro_escolar values (736828, 'Avendaño, 69', '11/04/2001', '33126645V', 798002);
